...
def generate_segmentation(args):
    ...
    sam_box_dir = "/home/datadisk/pipe/results/sam_box/"+datetime.now().strftime('%Y%m%d%H%M%S%f')+"/"+dataset_name+"/"+file_testing_name+"/"

    if not os.path.exists(sam_box_dir):
        # Create the directory
        os.makedirs(sam_box_dir)
